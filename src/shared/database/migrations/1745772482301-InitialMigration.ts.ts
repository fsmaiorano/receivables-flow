...
export class InitialMigration.ts1745772482301 implements MigrationInterface {
    name = 'InitialMigration.ts1745772482301'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "temporary_payable" ("id" varchar PRIMARY KEY NOT NULL, "value" decimal(10,2) NOT NULL, "emissionDate" datetime NOT NULL, "assignorId" varchar NOT NULL, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), CONSTRAINT "FK_c5115d307cedc33206805b3df1d" FOREIGN KEY ("assignorId") REFERENCES "assignor" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`);
